...
RESPONSE_TYPES = ['keepalive',
	                ...
	                'attenuation_warning',
	                'att',
	                'attenuation_recovery',
	                'att_rec']
DISPLAY_RESPONSE_TYPES = ['keepalive (alive)',
	                        'short',
	                        'open',
	                        'recovery (rec)',
	                        'attenuation_warning (att)',
	                        'attenuation_recovery (att_rec)']
REQUIRED_PARAMS = { keepalive: ['server_ip', 'device_id', 'device_version'],
...
DISPLAY_PARAMS_PATTERNS = {	'server_ip' => ['A.B.C.D[:PORT]', 'default: 127.0.0.1'],
...
PARAMS_PATTERNS = {	'server_ip' => /[0-9]{1,3}\.[0-9\.]+{3}\:?[0-9]{1,5}/,
	                  'device_id' => /[0-9]{5,6}/,
	                  'device_version' => /[0-9\.]+/,
	                  'cable_id' => /[0-9]+/,
	                  'distance' => /[0-9]+/,
